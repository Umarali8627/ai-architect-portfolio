...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Umar Ali — AI Engineer & ML Specialist" },
      { name: "description", content: "Umar Ali — AI Engineer specializing in Generative AI, RAG systems, Deep Learning, and Computer Vision. Building production intelligent systems with LangChain, TensorFlow, and FastAPI." },
